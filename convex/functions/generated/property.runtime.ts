...
function createProcedureRegistry() {
  ...
  "create": ["mutation", typedProcedureResolver(api["property"]["create"], () => (require("../property") as Record<string, unknown>)["create"])],
} as const;
...
export function createPropertyCaller<TCtx extends ProcedureCallerContext>(
  ctx: TCtx
...
export function createPropertyHandler<TCtx extends ProcedureHandlerContext>(
  ctx: TCtx
