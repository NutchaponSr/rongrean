...
function createProcedureRegistry() {
  ...
  "create": ["mutation", typedProcedureResolver(api["page"]["create"], () => (require("../page") as Record<string, unknown>)["create"])],
} as const;
...
export function createPageCaller<TCtx extends ProcedureCallerContext>(
  ctx: TCtx
...
export function createPageHandler<TCtx extends ProcedureHandlerContext>(
  ctx: TCtx
