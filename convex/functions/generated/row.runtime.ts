...
function createProcedureRegistry() {
  ...
  "update": ["mutation", typedProcedureResolver(api["row"]["update"], () => (require("../row") as Record<string, unknown>)["update"])],
} as const;
...
export function createRowCaller<TCtx extends ProcedureCallerContext>(
  ctx: TCtx
...
export function createRowHandler<TCtx extends ProcedureHandlerContext>(
  ctx: TCtx
